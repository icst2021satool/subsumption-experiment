...
* **checkoutbatch.sh**. This script checks out all the versions 1b (ou 25b, in the case of Collections) from Defect4J's repository. Note that Weka is not checked out since in source and object code is in this repository.
