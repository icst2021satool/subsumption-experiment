...
* **assertbatch.sh**. Calculates DUA coverage for all Defects4J's 1b (or 25b, in the case of Collections) versions, excepting Lang and Mockito. It also calculates DUA coverage for Weka 3.8.
